...
- Usage: Reference from command with `@C:/Users/prate/contact/Dgen/.cursor/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to C:/Users/prate/contact/Dgen/.cursor/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to C:/Users/prate/contact/Dgen/.cursor/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
