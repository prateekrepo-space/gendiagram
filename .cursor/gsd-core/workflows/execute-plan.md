...
@C:/Users/prate/contact/Dgen/.cursor/gsd-core/references/git-integration.md
</required_reading>
...
exactly as specified in the canonical `C:/Users/prate/contact/Dgen/.cursor/gsd-core/references/tdd.md` reference — the
...
See C:/Users/prate/contact/Dgen/.cursor/gsd-core/references/checkpoints.md for details.
</step>
...
If user_setup exists: create `{phase}-USER-SETUP.md` using template `C:/Users/prate/contact/Dgen/.cursor/gsd-core/templates/user-setup.md`. Per service: env vars table, account setup checklist, dashboard config, local dev notes, verification commands. Status "Incomplete". Set `USER_SETUP_CREATED=true`. If empty/missing: skip.
</step>
...
Create `{phase}-{plan}-SUMMARY.md` at `.planning/phases/XX-name/`. Use `C:/Users/prate/contact/Dgen/.cursor/gsd-core/templates/summary.md`.
