...
```
Agent(
  prompt="Read C:/Users/prate/contact/Dgen/.cursor/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/prate/contact/Dgen/.cursor/gsd-core/templates/SECURITY.md`
