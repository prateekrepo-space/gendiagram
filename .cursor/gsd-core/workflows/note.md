...
- **Global scope**: `C:/Users/prate/contact/Dgen/.cursor/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/prate/contact/Dgen/.cursor/notes/`)
...
2. Glob `C:/Users/prate/contact/Dgen/.cursor/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/prate/contact/Dgen/.cursor/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/prate/contact/Dgen/.cursor/notes/` — works in any directory
