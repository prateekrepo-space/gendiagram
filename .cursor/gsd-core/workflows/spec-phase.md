...
ones). Reference: @C:/Users/prate/contact/Dgen/.cursor/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / C:/Users/prate/contact/Dgen/.cursor.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "C:/Users/prate/contact/Dgen/.cursor/gsd-core/bin/lib/edge-probe.cjs" \
  "C:/Users/prate/contact/Dgen/.cursor/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @C:/Users/prate/contact/Dgen/.cursor/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @C:/Users/prate/contact/Dgen/.cursor/gsd-core/templates/spec.md.
