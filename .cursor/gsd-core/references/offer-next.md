...
Read and follow `C:/Users/prate/contact/Dgen/.cursor/gsd-core/workflows/transition.md`, passing through the `--auto` flag so it propagates to the next phase invocation.
