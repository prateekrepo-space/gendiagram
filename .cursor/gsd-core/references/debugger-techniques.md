...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = C:/Users/prate/contact/Dgen/.cursor
                  → checks C:/Users/prate/contact/Dgen/.cursor/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/Users/prate/contact/Dgen/.cursor/gsd-core
                  → writes to C:/Users/prate/contact/Dgen/.cursor/gsd-core/hooks/
