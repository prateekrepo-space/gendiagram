...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `C:/Users/prate/contact/Dgen/.cursor/.gsd-surface.json`
(sibling to `C:/Users/prate/contact/Dgen/.cursor/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `C:/Users/prate/contact/Dgen/.cursor/skills/gsd-*/`.
...
(`C:/Users/prate/contact/Dgen/.cursor`), NOT the skills sub-directory (`C:/Users/prate/contact/Dgen/.cursor/skills`).

This matches `installRuntimeArtifacts` and `uninstallRuntimeArtifacts`, which also
receive `C:/Users/prate/contact/Dgen/.cursor` as `configDir`. The skill dirs themselves live at
`C:/Users/prate/contact/Dgen/.cursor/skills/gsd-*/` because the `claude global` layout has `destSubpath =
'skills'` — they are derived from `configDir`, not the root for it.

```bash
# Cursor — global install
RUNTIME_CONFIG_DIR="${CLAUDE_CONFIG_DIR:-C:/Users/prate/contact/Dgen/.cursor}"
SCOPE="global"
...
(i.e. `C:/Users/prate/contact/Dgen/.cursor/.gsd-surface.json`).
...
<execution_context>
Surface state file: `C:/Users/prate/contact/Dgen/.cursor/.gsd-surface.json`
Install profile marker: `C:/Users/prate/contact/Dgen/.cursor/.gsd-profile`
Skill dirs: `C:/Users/prate/contact/Dgen/.cursor/skills/gsd-*/`
Engine module: `C:/Users/prate/contact/Dgen/.cursor/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `C:/Users/prate/contact/Dgen/.cursor/gsd-core/bin/lib/clusters.cjs`
</execution_context>
